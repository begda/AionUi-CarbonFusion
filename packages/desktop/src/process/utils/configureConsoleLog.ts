/**
 * @license
 * Copyright 2025 CarbonFusion (aionui.com)
 ...
 *   - macOS:   ~/Library/Logs/CarbonFusion/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\CarbonFusion\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/CarbonFusion/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
